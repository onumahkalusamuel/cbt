...
class ClassRoom
{
    ...
    /*
    CREATE TABLE `cbtexams`.`class` ( `id` INT NOT NULL AUTO_INCREMENT , `title` VARCHAR(50) NULL , `slug` VARCHAR(50) NULL , `status` TINYINT(1) NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; 
    */
