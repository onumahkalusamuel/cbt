...
class Subject
{
    ...
    // CREATE TABLE `cbtexams`.`subject` ( `id` INT(11) NOT NULL AUTO_INCREMENT , `title` VARCHAR(191) NULL , `slug` VARCHAR(191) NULL , `status` TINYINT(1) NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; 
